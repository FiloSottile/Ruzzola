...
(function() {
  var DL, DW, TL, TW, b64_de, bad, calc_points, current_word, discover, dom_grid, done, draw_path, found, go, grid, multiplier_state, multipliers, next, populate_wordslist, reset, results, values, vicini, walk, workers,
